...
\ifpdf
  \documentclass[ignoreframetext,envcountsect,xcolor=svgnames]{beamer}
\else
  \documentclass[ignoreframetext,dvips,trans,envcountsect,xcolor=svgnames]{beamer}
\fi
...
\date[19.12.2013]{Jan, $30^{th}$, 2014}
\subject{Exercise 1}
