...
and to provide worse results. In Table~\ref{} results of the algorithm
...
normalisation of data in date attribute}
\label{ypmsd:table:ds3sgdnormal}
\end{table}
...
algorithms}
\label{ypmsd:table:ds3comparison}
\end{table}
